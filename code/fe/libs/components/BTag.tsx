...
type BTagItem = { text: string; selected?: boolean }
type BTagData = { data: BTagItem[] }

export interface BTagProp {
  data?: BTagData
  dispatch?: (newData: BTagData) => void
  style?: StyleProp<ViewStyle>
}
export const BTag = (props: BTagProp) => {
  const text = useText()
